  ...
  implicit def showStep[I : Describe]: Show[Step[I]] = {
    def showVals[A : Describe](name: String, a: A): String = {
      ...
      val values = props.map { p =>
        val b = p.lens.get(a)
        s"${p.meta.label.name} = ${p.meta.propValue.shows(b)}"
      }
...
object BiasStep {
  ...
  def apply[I](implicit instance: BiasStep[I]): BiasStep[I] = instance
}
...
object DarkStep {
  ...
  def apply[I](implicit instance: DarkStep[I]): DarkStep[I] = instance
}
...
object GcalStep {
  ...
  def apply[I](implicit instance: GcalStep[I]): GcalStep[I] = instance
}
...
object ScienceStep {
  ...
  def apply[I](implicit instance: ScienceStep[I]): ScienceStep[I] = instance
}
...
object SmartStep {
  ...
  def apply[I](implicit instance: SmartStep[I]): SmartStep[I] = instance
}